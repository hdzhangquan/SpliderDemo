	...
	public static List<LinkTypeData> extract(Rule rule)
	{
		...
		try
		{
			...
			for (Element result : results)
			{
				...
				Elements links2 = result.getElementsByTag("div");
				//Elements links2 = result.getElementsByTag("h1");
				for (Element link : links2)
				{
					//必要的筛选
					String className = link.attr("class");
					//String className = link.attr("id");
				...
				Elements links3 = result.getElementsByTag("img");

				for (Element link : links3)
				{
					//必要的筛选
					String imageUrl = link.attr("original");
					//String linkText = link.text();
